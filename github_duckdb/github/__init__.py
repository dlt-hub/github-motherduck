...
@dlt.source
def github_stargazers_source(owner, repo, access_token: str = dlt.secrets.value):
    return stargazers(owner, repo), stargazers_starred_repos(owner, repo,access_token)